...
{/* {showOn&&<div>{Math.round((manW-100)*1.15)+' кг'}</div>} */}
  {showOn && <div className='brokW_calculator_result'>Идеальный вес по формуле Брока:  <span> {` ${Math.round((middleware-110)*1.15)}кг`}</span></div>}
